...
This version also uses minified Javascript files (it's hard-coded for now) - you must generate the minified scripts from the source before uploading the  application, like so:
...
Also if you want to use locally hosted YUI files while developing, download the "latest build":http://yuilibrary.com/downloads/ and copy the 'build' directory to @static/hosted/yui@
